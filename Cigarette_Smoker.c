...
Following is the solution of Cigarette-Smokers Problem
...
void * smoker_tobacco(void * arg){
    ...
    while(1){
        ...
        agent_job = 1;
        puts("Tobacco Smoker is making cigarette.");
        pthread_mutex_unlock(&smoker);
        
        puts("Tobacco Smoker is Smoking.");
    }
...
void * smoker_paper(void * arg){
    ...
    while(1){
        ...
        smoker_paper_job = 0;
        agent_job = 1;
        puts("Paper Smoker is making cigarette");
        pthread_mutex_unlock(&smoker);
        
        puts("Paper Smoker is Smoking");
    }
...
void * smoker_match(void * arg){
    ...
    while(1){
        ...
        smoker_match_job = 0;
        agent_job = 1;
        puts("Match Smoker making cigarette");
        pthread_mutex_unlock(&smoker);
        
        puts("Match Smoker is Smoking");
    }
